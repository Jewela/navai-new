...
function DeleteInterceptQuestion(props) {
    ...
    async function deleteQuestionById() {
        ...
        try {
            ...
            const { status, data: { result, httpStatusCode } } = await deleteRequest(`${questionEndpoint}?reqDto=${id}`);
...
export default DeleteInterceptQuestion