...
function QuestionsList() {
    ...
    async function getFamilyQuestions() {
        ...
        try {
            const { status, data: { httpResponseDetail: { httpStatusCode }, result: { data: { questionResponses } }, count }, } = await postRequest(ADMIM.FAMILY_QUESTION.LIST, payloadData);
        ...
        <div className='grid1'>
            ...
            {!loader &&
                <>
                    ...
                    <ReactPaginate
                        key="family-parent-questions-pagination"
                        // className="family-parent-questions-pagination"
                        nextLabel="Next >"
                        ...
                        pageCount={pageCount}
                    />
                    <Link to={ADMIN_ROUTE_SLUGS.ADD_FAMILY_QUESTION} state={{ questionType: 'parent', parentQuestionId: 0 }} className="btn primary-btn btn-xs">
