...
import actions, { CHAT_ACTIONS, RECENT_AVATARS_ACTION as recent_actions } from "../../../../redux/authenticate/actions";
import { useDispatch, useSelector } from "react-redux";
import toast from "react-hot-toast";

function AvatorDetails() {
    const { id: avatorId } = useParams();
    const { isAuthenticated, userData: { id: userId, userSubscriptionStatus = false } } = useSelector(state => state.auth);
    ...
    async function getAvtarById(url) {
        ...
        try {
            ...
            if (status === RESPONSE_CODE[200] && httpStatusCode === RESPONSE_CODE[200]) {
                ...
                const { name, images, personalDetailDto, avatarCategoryEnum, hasAvatarActiveSubscription } = data;
