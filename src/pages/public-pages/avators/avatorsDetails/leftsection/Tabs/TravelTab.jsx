...
function Travel(props) {
    ...
    const getTravelPhotos = async (URL) => {
    ...
    useEffect(() => {
        getTravelPhotos(AVTAR.GET_AVATAR_MEDIA)
    }, []);
        ...
        <>
            <div className="gallery-grid mb-3">
                {travelPhotos.length > 0 ?
                    travelPhotos.map((mediaItem, index) => (
            ...
            <Link to={`${PUBLIC_ROUTES_SLUGS.AVATORS}/${avatarId}/${MEDIA_CATEGORY_PHOTOS.TRAVEL}`}>
